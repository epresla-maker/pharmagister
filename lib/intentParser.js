  ...
  const intents = [
    {
      ...
      action: 'greeting',
      reply: 'Szia! Betti vagyok, a Pharmagister AI asszisztense, Epres Laszlo fejlesztese. Segitek beosztassal, szabadsaggal, tuloraval es ujratervezessel kapcsolatban.',
    },
    {
      key: 'thanks',
      confidence: 0.95,
