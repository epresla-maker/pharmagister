        ...
        <div className={`${darkMode ? 'bg-gray-800 text-gray-200' : 'bg-white text-gray-700'} rounded-xl shadow-sm p-6 space-y-6`}>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Email:</strong> Reports can also be sent directly to <a href="mailto:safety@pharmagister.hu" className="text-purple-600 hover:underline">safety@pharmagister.hu</a></li>
            </ul>
            <p className="leading-relaxed mt-3">
          ...
          <section>
            ...
            <div className={`${darkMode ? 'bg-gray-700' : 'bg-gray-100'} rounded-lg p-4 space-y-2`}>
              ...
              <p><strong>Email:</strong> <a href="mailto:safety@pharmagister.hu" className="text-purple-600 hover:underline">safety@pharmagister.hu</a></p>
              ...
              <div className="mt-4 space-y-6">
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li><strong>Email:</strong> <a href="mailto:safety@pharmagister.hu" className="text-purple-600 hover:underline">safety@pharmagister.hu</a></li>
                  </ul>
                </section>
          ...
          <div className={`border-t pt-4 mt-6 text-sm ${darkMode ? 'border-gray-700 text-gray-400' : 'border-gray-200 text-gray-500'}`}>
            ...
            <p>Contact: <a href="mailto:safety@pharmagister.hu" className="text-purple-600 hover:underline">safety@pharmagister.hu</a> | <a href="mailto:info@pharmagister.hu" className="text-purple-600 hover:underline">info@pharmagister.hu</a></p>
            <p className="mt-2">
